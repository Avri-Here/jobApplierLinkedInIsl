...
# Your legal name
first_name = "Avraham"             # Your first name in quotes Eg: "First", "Sai"
middle_name = ""                   # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Yom Tov"              # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "0533300845"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Tel Aviv"                  # Los Angeles, San Francisco, etc.
'''
